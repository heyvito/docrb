RSpec.describe Docrb::RubyParser do
  it "extracts accessors" do
    ...
    expect(cls[:attr_accessor]).to eq([
      { docs: nil, name: :foo, reader_visibility: :public, writer_visibility: :public },
      { docs: nil, name: :bar, reader_visibility: :public, writer_visibility: :public },
      { docs: nil, name: :baz, reader_visibility: :public, writer_visibility: :public }
    ])
  end
end
